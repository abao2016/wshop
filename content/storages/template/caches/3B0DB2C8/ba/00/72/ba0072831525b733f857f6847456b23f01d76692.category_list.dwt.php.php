...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_597d67101eea87_60388299',
  'cache_lifetime' => '3600',
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_597d67101eea87_60388299')) {function content_597d67101eea87_60388299($_smarty_tpl) {?><title>商家列表-ECJia到家 - 同城上门O2O解决方案 - Powered by ECJia</title>
	...
	<div class="ecjia-content">
		<div class="ecjia-fl ecjia-logo">
			...
			<div class="select-location">
				...
				<span class="current-position">广州</span>
		...
		<div class="ecjia-fr">
			<ul class="nav">
				...
				<li class="active"><a class="merchant-list" href="http://localhost/index.php?m=merchant&c=store&a=category">商家</a></li>
...
<div class="category m_b0">
    <div class="ecjia-content">
    	        <div class="category-cycleimage">
			<div id="swiper-merchant-cycleimage" class="swiper-container">
				<div class="swiper-wrapper">
										<div class="swiper-slide" style="background:url('http://localhost/content/uploads/data/cycleimage/1492650692097234468.png') center center no-repeat;">
						<a href="https://cityo2o.ecjia.com/index.php?m=merchant&c=store&a=category"></a>
					</div>
									</div>
							</div>
        </div>
...
<div class="ecjia-no-content">
	<div class="content">
		<div class="content-container">
			<div class="current-city">当前选择城市：广州</div>
