...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_597d6193004ef3_84868915',
  'cache_lifetime' => 1800,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_597d6193004ef3_84868915')) {function content_597d6193004ef3_84868915($_smarty_tpl) {?><!DOCTYPE html>
<html>
	<head lang="zh-CN">
		    ...
		    <div class="row">
		        <div class="col-mb-12 col-tb-8 col-tb-offset-2">
					<div class="column-14 start-06 ecjia-install">
		             	<form method="post" action='<?php echo RC_Uri::url("installer/index/detect");?>
'>
