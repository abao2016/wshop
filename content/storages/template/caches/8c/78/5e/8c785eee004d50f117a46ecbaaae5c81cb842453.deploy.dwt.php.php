...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_597d61ad3374b2_95270197',
  'cache_lifetime' => 1800,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_597d61ad3374b2_95270197')) {function content_597d61ad3374b2_95270197($_smarty_tpl) {?><!DOCTYPE html>
<html>
	<head lang="zh-CN">
						...
						<form id="js-ecjia_deploy">
		                    ...
		                    <div class="ecjia-install-body">
		                        ...
		                        <ul class="ecjia-option">
								    ...
								    <li class="control-group">
								    	<div class="check_db_correct" data-url="<?php echo RC_Uri::url('installer/index/check_db_correct');?>
">
								    ...
								    <li class="control-group">
                                        <div class="check_db_exists" data-url="<?php echo RC_Uri::url('installer/index/check_db_exists');?>
">
		                        ...
		                        <ul class="ecjia-option">
		              			...
		              			<h4>杂项</h4>
		                  		<ul class="ecjia-option">
			              			<!--<?php if ($_smarty_tpl->tpl_vars['show_timezone']->value=='yes') {?> -->
			                      	<li>
...
" <?php if ($_smarty_tpl->tpl_vars['key']->value==$_smarty_tpl->tpl_vars['local_timezone']->value) {?> selected="true"<?php }?>><?php echo $_smarty_tpl->tpl_vars['item']->value;?>
</option>
												<!-- <?php } ?> -->
											</select>
										</div>
		                    ...
		                    <input type="hidden" name="index" value="<?php echo RC_Uri::url('installer/index/init');?>
" />
		                    <input type="hidden" name="done" value="<?php echo RC_Uri::url('installer/index/finish');?>
" />
		                    <input type="hidden" name="create_config_file" value="<?php echo RC_Uri::url('installer/index/create_config_file');?>
" />
		                    <input type="hidden" name="create_database" value="<?php echo RC_Uri::url('installer/index/create_database');?>
" />
		                   	<input type="hidden" name="install_structure" value="<?php echo RC_Uri::url('installer/index/install_structure');?>
" />
		                    <input type="hidden" name="install_base_data" value="<?php echo RC_Uri::url('installer/index/install_base_data');?>
" />
		                    <input type="hidden" name="install_demo_data" value="<?php echo RC_Uri::url('installer/index/install_demo_data');?>
" />
		                    <input type="hidden" name="create_admin_passport" value="<?php echo RC_Uri::url('installer/index/create_admin_passport');?>
" />
		                    <input type="hidden" name="do_others" value="<?php echo RC_Uri::url('installer/index/do_others');?>
" />
		                    <input type="hidden" name="correct_img" value="<?php echo $_smarty_tpl->tpl_vars['correct_img']->value;?>
" />
		                    <input type="hidden" name="error_img" value="<?php echo $_smarty_tpl->tpl_vars['error_img']->value;?>
" />
