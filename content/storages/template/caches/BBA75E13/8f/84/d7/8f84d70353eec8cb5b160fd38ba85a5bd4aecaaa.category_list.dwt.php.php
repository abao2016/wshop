...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_597d6c505a36e5_41347931',
  'has_nocache_code' => false,
  'cache_lifetime' => '3600',
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_597d6c505a36e5_41347931')) {function content_597d6c505a36e5_41347931($_smarty_tpl) {?><title>所有分类-ECJia到家 - 同城上门O2O解决方案</title>


<div class="ecjia-mod category">
	<div class="ecjia-mod ecjia-header ecjia-header-index">
	<div class="ecjia-search-header">
		<span class="bg search-goods" data-url="http://localhost/sites/m/index.php?m=touch&c=index&a=search" >
			<i class="iconfont icon-search"></i>搜索附近门店		</span>
	</div>
</div>
    <ul class="ecjia-list category_left">
                <li class="active"><a href="javascript:;" data-rh="1" data-val="1">iphone</a></li>
            </ul>
    <div class="category_right">
					<div class="cat_list ecjia-category-list show" id="category_1">
	            <a href="http://localhost/sites/m/index.php?m=goods&c=category&a=store_list&cid=1">
	            	<img src="" alt="iphone">
	            </a>
...
<div class="ecjia-mod ecjia-floor ecjia-bottom-bar-pannel o category">
